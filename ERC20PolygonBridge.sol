...
contract ERC20PolygonBridge {
  ...
  function release( 
    ...
    erc20.mint(to, amount - fee_amount);
    if(penalty_amount > 0) {
      if(penalty_amount > fee_amount) {
        ...
        erc20.mint(fee_wallets[msg.sender], fee_amount - penalty_amount);
        penalty_amount -= penalty_amount;
      }
    }
    else {
      erc20.mint(fee_wallets[msg.sender], fee_amount);
    }
